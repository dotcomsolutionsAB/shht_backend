    ...
    public function summary(Request $request)
    {
        try {
            ...
            $ordersAgg = $ordersQuery->selectRaw("
                ...
                SUM(CASE WHEN status = 'dispatched' THEN 1 ELSE 0 END) as total_dispatched_orders,
                SUM(CASE WHEN status = 'invoiced' THEN 1 ELSE 0 END) as total_invoiced_orders,
                ...
                SUM(CASE WHEN status = 'dispatched' THEN order_value ELSE 0 END) as total_dispatched_order_value,
                SUM(CASE WHEN status = 'invoiced' THEN order_value ELSE 0 END) as total_invoiced_order_value,
            ...
            return response()->json([
                ...
                'data'    => [
                    ...
                    'order_values'           => [
                        ...
                        'dispatched'   => (float) ($ordersAgg->total_dispatched_order_value ?? 0),
                        'invoiced'     => (float) ($ordersAgg->total_invoiced_order_value ?? 0),
                    ...
                    'total_dispatched_orders'=> (int) ($ordersAgg->total_dispatched_orders ?? 0),
                    'total_invoiced_orders'  => (int) ($ordersAgg->total_invoiced_orders ?? 0),
