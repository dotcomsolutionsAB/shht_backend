...
class OrdersModel extends Model
{
    ...
    protected $fillable = ['company', 'client', 'client_contact_person', 'email', 'mobile', 'so_no', 'so_date', 'order_no', 'order_date', 'invoice', 'status', 'initiated_by', 'checked_by', 'dispatched_by', 'drive_link'];
